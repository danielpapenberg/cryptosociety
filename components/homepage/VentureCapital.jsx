...
export default function VentureCapital() {
    return(
        <div className="py-20 text-center">
            <h2 className="relative px-20 text-9xl select-none text-gray-700 tracking-wide font-extrabold left-[-20px]">Venture Capital</h2>
            <p className="px-20 pt-10 text-2xl lg:w-2/3 m-auto">
